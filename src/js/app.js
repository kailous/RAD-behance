...
(function (root, factory) {
    ...
    var Behance = function (options) {
        ...
        this.endpoint = '/api/behance?user=' + encodeURIComponent(options.user);
        this.body     = document.querySelector('body');
        this.loader   = document.querySelector('.loading');
        this.container = document.querySelector('#portfolio-section') || this.body;
    ...
    Behance.prototype = {
                ...
                if (this.readyState === 4) {
                    if ((this.status >= 200 && this.status < 300) || this.status === 304) {
                        try {
                            ...
                            fail.call(this, 'Unable to parse response');
                        }
                    } else {
        ...
        structureHeader: function () {
            ...
            (this.container || this.body).appendChild(elements);
        ...
        mountProjects: function (data) {
            ...
            this.each(data.projects, function (project) {
                ...
                a      = this.createEls('a', { href: 'project.html?id=' + project.id, className: 'project-link', target: '_blank', rel: 'noopener noreferrer' });
        ...
        request: function () {
            if (!this.supportsSvg()) {
            this.loader.src = './css/img/loading.gif';
            }
